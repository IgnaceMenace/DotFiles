...
"Map the copy past to/from outside NeoVim (note that this isn't necessary
"in NeoVim but is in Vim
vnoremap <C-c> "+y
map <C-p> "+P
"
...
:set mouse=a
"
""Enable the plug-in manager after download, the plug in is named
"vim-plug
"sh -c 'curl -fLo
