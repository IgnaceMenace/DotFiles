...
def powerMenu():
  ...
  choice = os.popen("echo -e '" + options + "' | fuzzel -f 'JetBrainsMono NF' -C ebcb8bff -b 1d1f21ff -T footclient -B 3 -t 88c0d0ff -m a3be8cff -S d8dee9ff -s bf616aff -d -w 10 -l 6").readline().strip()
  if choice in keys:
